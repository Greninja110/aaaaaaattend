...
from core.models import (
    Department, Faculty, Student, AcademicYear, SystemLog, ClassSection, Batch,
    Subject, FacultySubject, ElectiveSubject, Timetable, Attendance
)
...
from .forms import (
    ...
    StudentDetailsForm, SubjectForm, ElectiveSubjectForm, FacultySubjectForm, 
    TimetableForm
)
